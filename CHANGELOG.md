...
------------
### Changed
- The license from `MIT` to `BSD-3-Clause`.

[1.4.0] - 2025-10-09
--------------------
### Added
- Support for backtick quotes when generating code blocks.
...
[Unreleased]: https://github.com/jbenner-radham/node-readme-md/compare/v1.4.0...HEAD
[1.4.0]: https://github.com/jbenner-radham/node-readme-md/compare/v1.3.1...v1.4.0
